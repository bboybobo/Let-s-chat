...
public class LinkLabel extends JLabel {
	...
	public LinkLabel(Object obj, Icon icon, final Action action) {
		super();
		setContent(obj);
		...
		if (icon != null) {
			setIcon(icon);
			setForeground(GuiUtils.getLookAndFeelColor("foregroundColor"));
		} else
			setForeground(GuiUtils.getLookAndFeelColor("foregroundColor"));

		setText(obj.toString());
		int sub = 100 - getText().length();
	...
	public void HandleMouseEntered(MouseEvent event) {
		...
		Color c = GuiUtils.getLookAndFeelColor("lightColor") == null ? UIManager
